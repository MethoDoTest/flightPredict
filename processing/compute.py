from EDA import load_data, show_basic_info, plot_histogram, plot_boxplot, analyze_missing_values, \
    generate_feature_report, plot_correlation_matrix, plot_pairplot, plot_scatter, create_new_features, \
    plot_price_vs_date_features


def main():
    csv_path = './dataset/flight_dataset.csv'

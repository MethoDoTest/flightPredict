...
class TestValidationDonnees(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.df_valid = pd.DataFrame({
            ...
            'Total_Stops': [0, 2, 2],
            # 'Price': [-3897, 7662, 13882], #tester avec une valeur négative sur les prix 
    ...
    def test_valider_types_donnees(self):
        ...
        for colonne, resultat in resultats.items():
            self.assertTrue(resultat['valide'], f"Type mismatch in column {colonne}: expected {resultat['expected']}, got {resultat['actual']}")
